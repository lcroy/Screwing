...
if __name__ == "__main__":
    ...
    model_path, loss_img, acc_img, precision, recall, f1, balanced_accuracy, roc = cfg.model_parameters_set_process_task("LSTM_org_data", args.is_org_data_only_process, args.is_flt)
